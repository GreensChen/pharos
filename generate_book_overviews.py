...
def _extract_author_line(overview: str) -> tuple[str, str]:
    """從 Gemini 回的 overview 第一行抓 `作者：xxx` 出來。
    回傳 (extracted_author, body_without_first_line)。
    沒有的話 extracted_author 為空字串、body 不變。"""
...
def render_book_md(title: str, author: str, overview: str, source_filename: str) -> str:
    extracted_author, body = _extract_author_line(overview)
